...
local WIDGET_DIR = HOME_DIR .. '/.config/awesome/my-widgets/weather'
...
local function worker(args)
    ...
    local function update_widget(widget, stdout, stderr)
        ...
        widget:set_text(gen_temperature_str(result.current.temp, '%.0f', false, units))
    ...
    weather_widget:connect_signal("mouse::leave", function(c) weather_popup.visible = false end)
