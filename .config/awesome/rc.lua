...
local icon = {}
icon.widget_temp    = icon_dir .. "temp.png"
icon.widget_uptime  = icon_dir .. "ac.png"
icon.widget_cpu     = icon_dir .. "cpu.png"
icon.widget_weather = icon_dir .. "dish.png"
icon.widget_fs      = icon_dir .. "fs.png"
icon.widget_mem     = icon_dir .. "mem.png"
icon.widget_note    = icon_dir .. "note.png"
icon.widget_note_on = icon_dir .. "note_on.png"
icon.widget_netdown = icon_dir .. "net_down.png"
icon.widget_netup   = icon_dir .. "net_up.png"
icon.widget_mail    = icon_dir .. "mail.png"
icon.widget_batt    = icon_dir .. "bat.png"
icon.widget_clock   = icon_dir .. "clock.png"
icon.widget_vol     = icon_dir .. "spkr.png"
